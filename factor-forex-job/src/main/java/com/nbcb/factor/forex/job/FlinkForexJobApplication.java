package com.nbcb.factor.forex.job;
...
import com.nbcb.factor.common.key.MyKey;
import com.nbcb.factor.entity.localcurrency.LocalCurrencyStrategyInstanceResult;
import com.nbcb.factor.event.*;
import com.nbcb.factor.flink.*;
import com.nbcb.factor.gateway.input.FlinkFxKafkaEventInputGateway;
import com.nbcb.factor.gateway.output.FlinkOutputGateway;
import com.nbcb.factor.gateway.output.JsonSchemaTuple2;
import com.nbcb.factor.job.ForexJob;
import com.nbcb.factor.job.engine.ForexSyncEventEngine;
import com.nbcb.factor.monitor.api.SignalModelHandlerFunction;
...
import com.nbcb.factor.strategy.ForexStrategy;
