package com.nbcb.factor.web.job;

import com.nbcb.factor.web.job.calc.impl.ChinaBondSpreadPercentileCalcJob;
import com.nbcb.factor.web.job.calc.impl.ChinaBondSpreadVolatilityCalcJob;
import com.nbcb.factor.web.job.calc.impl.FactorStrategyInstanceCalcJob;
import com.nbcb.factor.web.job.history.impl.HistorySyncJob;
